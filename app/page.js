        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="hidden sm:ml-6 sm:flex sm:items-center space-x-4">
              ...
              <a
                href="https://github.com/Surya2Developer/StudyPal"
                target="_blank"
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                {
                  quote:
                    "StuddyPal helped me ace my finals. The personalized flashcards were exactly what I needed!",
                  name: "Sarah Johnson",
                ...
                {
                  quote:
                    "The practice tests generated by StudyPal perfectly matched my learning style. Highly recommend!",
                  name: "Emma Rodriguez",
          ...
          <div className="max-w-7xl mx-auto">
            <div className="border-gray-800 dark:border-gray-700 text-sm text-center text-gray-400 dark:text-gray-500 space-y-2">
              ...
              <p className="flex items-center justify-center gap-1">
                ...
                <a
                  href="https://github.com/Surya2Developer"
                  target="_blank"
                  rel="noopener noreferrer"
