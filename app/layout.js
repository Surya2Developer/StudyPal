...
export const metadata = {
  title: {
    default: "StudyPal - AI-Powered Study Material Generator",
    template: "%s | StudyPal"
  },
  description: "Create personalized study materials with AI. Generate flashcards, notes, quizzes, and Q&A sessions in minutes. Boost your learning with StudyPal's cutting-edge AI technology.",
  ...
  openGraph: {
    ...
    locale: 'en_US',
    url: '/',
    title: 'StudyPal - AI-Powered Study Material Generator',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'StudyPal - AI Study Material Generator',
      },
    ],
  },
  twitter: {
    ...
    <ClerkProvider appearance={{ baseTheme: outfit.className }} dynamic={true}>
      <html lang="en" suppressHydrationWarning>
        <head>
          ...
          <meta name="application-name" content="StuddyPal" />
          <meta name="apple-mobile-web-app-capable" content="yes" />
          <meta name="apple-mobile-web-app-status-bar-style" content="default" />
          <meta name="apple-mobile-web-app-title" content="StudyPal" />
